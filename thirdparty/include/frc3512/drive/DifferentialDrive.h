...
#include "frc3512/drive/RobotDriveBase.h"
...
class DifferentialDrive : public RobotDriveBase {
 public:
  ...
  struct Output {
    ...
    Output(double left, double right) {
      this->left = left;
      this->right = right;
    }
  };
   ...
   */
  Output ArcadeDrive(double xSpeed, double zRotation, bool squareInputs = true);
   ...
   */
  Output CurvatureDrive(double xSpeed, double zRotation, bool isQuickTurn);
   ...
   * @param squareInputs If set, decreases the input sensitivity at low speeds.
   */
  Output TankDrive(double leftSpeed, double rightSpeed,
